            ...
            {bookingDetail ?
                (<section className="text-gray-600 body-font">
                    <div className="container mx-auto flex px-5 py-3 items-center justify-center flex-col">
                        <div className="text-center lg:w-2/3 w-full shadow-lg lg:py-16 py-10 rounded-md">
                            ...
                            <p className="leading-relaxed">You have booked successfully ticket on {bookingDetail?.dateOfBooking}</p>
                            <p className="leading-relaxed">Your Seat Number {bookingDetail?.seatNumber.substring(5)}</p>
                            <p className="mb-8 leading-relaxed">Your Deck is: {bookingDetail?.deck}</p>
